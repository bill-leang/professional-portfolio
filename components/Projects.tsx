    ...
    <section id="projects" className="bg-white py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <iframe title="Project1_DiabetesHospitalisn_PUBLISHED" width="100%" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiMWUzZTRjYTYtNzBmZC00ZTY3LWE3MDUtZmQzNzY0NjQxNGJhIiwidCI6IjVmODIxZDFlLTNlMjEtNGQ0NC1iNGU5LWFiNjY5OWY4MDJjMCJ9&pageName=f04c2a695cde92115eb0" frameborder="0" allowFullScreen="true"></iframe>
        </div>
